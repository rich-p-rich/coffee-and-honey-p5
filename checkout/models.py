...
class Order(models.Model):
    ...
    # If customer chooses pick-up,
    # delivery_cost will be set to 0 in delivery_options
    ...
    def delivery_options(self, form=None, user=None):
        ...
        """
        if self.pick_up:
            # If the customer chooses to pick up in the cafe,
            # set delivery cost to 0
            ...
            if user and user.profile.saved_addresses.exists():
                saved_address = user.profile.saved_addresses.last()
                self.copy_address(
                    saved_address.name,
            ...
            # If billing address == delivery address,
    ...
    def copy_address(
         self, name, street1, street2, town, county, postcode, country):
        """
