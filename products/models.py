...
class ProductVariant(models.Model):
    ...
    weight = models.DecimalField(max_digits=6, decimal_places=2)  # Weight of the product
...
class Service(models.Model):
    ...
    surcharge = models.DecimalField(max_digits=6, decimal_places=2)  # Additional cost for the service
