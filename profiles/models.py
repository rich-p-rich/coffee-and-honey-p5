...
class RecipientAddresses(models.Model):
    ...
    user_profile = models.ForeignKey(
        UserProfile, on_delete=models.CASCADE, related_name='saved_addresses')
    recipient_name = models.CharField(max_length=50)
    recipient_phone_number = models.CharField(
        max_length=20, null=True, blank=True)
    recipient_street_address1 = models.CharField(max_length=80)
    recipient_street_address2 = models.CharField(
        max_length=80, null=True, blank=True)
    ...
    nickname = models.CharField(
        ...
        help_text="Nickname for this address (e.g., 'Mum and Dad', etc)"
        )
    is_default = models.BooleanField(default=False)

    def __str__(self):  # For the 'choose saved address' in checkout
        return self.nickname or self.recipient_name
